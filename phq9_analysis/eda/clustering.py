...
class OptimalClusterSelector:
    ...
    def elbow_method(self, data: pd.DataFrame, max_clusters: int = 15) -> Tuple[int, List[float]]:
        """
        ...
        # Find elbow using angle method : +2 because we start from k = 2
        optimal_k = self._find_elbow_angle(inertias) + 2  
